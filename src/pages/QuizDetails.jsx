...
const QuizDetails = () => {
  ...
  return (
    <>
      <div className="lg:container lg:mx-auto lg:py-16 md:py-12 md:px-6 py-12 px-4">
        ...
        <div className="w-full flex justify-center ">
          <div className="relative flex h-10 w-full min-w-[200px] max-w-[24rem]">
            ...
            <input
              type="email"
              className="peer h-full w-full rounded-[7px] border border-blue-gray-200 bg-transparent px-3 py-2.5 pr-20 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500   disabled:border-0 disabled:bg-blue-gray-50"
              placeholder=" "
              value={quiz._id}
              required
            />
      ...
      <div className="flex shadow-sm"></div>

      {!participants.length < 1 && (
        <div className="overflow-x-auto">
          <p className="text-4xl text-center text-[#0095FF] font-bold">
           Participants
          </p>
