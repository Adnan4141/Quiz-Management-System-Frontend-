...
const SigninPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto h-[40rem] flex justify-center items-center flex-col">
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white   font-sans mx-auto">
        ...
        <form action="" onSubmit={handleSubmit} className="space-y-6">
          ...
          <p className="text-red-400 font-semibold ">!{firebaseErr}</p>
            ...
            <div className="flex justify-end text-xs ">
              ...
              <a href="#" className="hover:underline text-blue-800 font-semibold">
                Forgot Password?
              </a>
            </div>
          </div>
       ...
       <div className="flex items-center pt-4 space-x-2">
        ...
        <p className="text-sm text-center gap-2 flex justify-center sm:px-6 ">
          ...
          <a href="/Signup" className="underline hover:text-indigo-600">
            Sign up
          </a>
        </p>
       </div>
